			...
			<table class="table">
				...
				<tbody>
					...
					<tr>
						...
						<th><a href='<spring:url value="/admin/productInventory/deleteProduct/${product.idProduct}"></spring:url>'><span class=" glyphicon glyphicon-remove"/></a><a href='<spring:url value="/productList/productDetail/${product.idProduct}"></spring:url>'><span class=" glyphicon glyphicon-info-sign"/></a></th>						
					</tr>
					</c:forEach>
				</tbody>
